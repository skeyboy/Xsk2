...
import xsk.com.xsk.adapter.LogAdapter;
import xsk.com.xsk.data.HandShakeBean;
import xsk.com.xsk.data.LogBean;
import xsk.com.xsk.data.MsgDataBean;
import xsk.com.xsk.utility.Utility;
...
public class SimpleDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        setListener();
        mIPET.setText(Utility.getIPAddress(this));
        mManager.connect();
    }
